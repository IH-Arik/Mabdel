...
const INITIAL_PROMPTS = {
  ...
  'zh-CN': {
    invoice: '请告诉我发票的详情——客户姓名、服务说明、金额和到期日。',
    agreement: '请告诉我协议的详情——客户姓名、协议类型和开始日期。',
    lease: '请告诉我租约的详情——租户姓名、房产地址和月租金。',
    bulk_message: '您想发送什么消息，发给谁？',
    calendar: '请告诉我会议的详情——标题、日期和时间。',
    contact: '请告诉我联系人的详情——名字、姓氏、电话和邮箱。',
  },
  'ja-JP': {
    invoice: '請求書について教えてください——クライアント名、サービス内容、金額、支払期日。',
    agreement: '契約について教えてください——クライアント名、契約の種類、開始日。',
    lease: '賃貸契約について教えてください——借主名、物件住所、月額家賃。',
    bulk_message: 'どのようなメッセージを誰に送りますか？',
    calendar: 'ミーティングについて教えてください——タイトル、日付、時間。',
    contact: '連絡先について教えてください——名前、電話番号、メールアドレス。',
  },
};
...
const FIELD_QUESTIONS = {
  ...
  'zh-CN': {
    agreement: {
      prompt: '请用一句话描述该协议。',
      client_name: '客户的全名是什么？',
      client_email: '客户的电子邮箱是什么？（例如 john@gmail.com）',
      client_phone: '客户的电话号码是什么？',
      agreement_type: '这是什么类型的协议？例如：保密协议（NDA）、服务协议或合同。',
      start_date: '开始日期是什么时候？',
      title: '协议标题应该是什么？',
    },
    lease: {
      prompt: '请简要描述租约——租户、房产和租金。',
      tenant_name: '租户的全名是什么？',
      tenant_email: '租户的电子邮箱是什么？（例如 john@gmail.com）',
      tenant_phone: '租户的电话号码是什么？',
      landlord_name: '房东的姓名是什么？',
      property_address: '房产的完整地址是什么？',
      property_type: '房产类型是什么？公寓、房屋还是办公室？',
      monthly_rent: '每月租金是多少？',
      security_deposit: '押金是多少？',
      start_date: '租约开始日期是什么时候？',
      end_date: '租约结束日期是什么时候？',
    },
    invoice: {
      client_name: '客户的全名是什么？',
      client_email: '客户的电子邮箱是什么？（例如 john@gmail.com）',
      items: '服务或产品是什么？请说明数量、描述和价格。例如：3小时网页设计，每小时50美元。',
      due_date: '付款截止日期是什么时候？',
      notes: '这张发票有什么备注吗？',
    },
    bulk_message: {
      content: '消息内容是什么？',
    ...
    contact: {
      first_name: '联系人的名字是什么？',
      last_name: '联系人的姓氏是什么？',
      phone: '联系人的电话号码是什么？',
      email: '联系人的电子邮箱是什么？（例如 john@gmail.com）',
      date_of_birth: "联系人的出生日期是什么？（跳过请说 'skip'）",
      notes: "有备注吗？（跳过请说 'skip'）",
    },
  },
  'ja-JP': {
    agreement: {
      prompt: '契約内容を一文で説明してください。',
      client_name: 'クライアントのフルネームは何ですか？',
      client_email: 'クライアントのメールアドレスは何ですか？（例：john@gmail.com）',
      client_phone: 'クライアントの電話番号は何ですか？',
      agreement_type: 'どのような契約ですか？例：NDA、サービス契約、または一般契約。',
      start_date: '開始日はいつですか？',
      title: '契約のタイトルは何にしますか？',
    },
    lease: {
      prompt: '賃貸契約について簡単に説明してください——借主、物件、家賃。',
      tenant_name: '借主のフルネームは何ですか？',
      tenant_email: '借主のメールアドレスは何ですか？（例：john@gmail.com）',
      tenant_phone: '借主の電話番号は何ですか？',
      landlord_name: '貸主の名前は何ですか？',
      property_address: '物件の完全な住所は何ですか？',
      property_type: '物件の種類は何ですか？アパート、一戸建て、それともオフィスですか？',
      monthly_rent: '月額家賃はいくらですか？',
      security_deposit: '敷金はいくらですか？',
      start_date: '賃貸契約の開始日はいつですか？',
      end_date: '賃貸契約の終了日はいつですか？',
    },
    invoice: {
      client_name: 'クライアントのフルネームは何ですか？',
      client_email: 'クライアントのメールアドレスは何ですか？（例：john@gmail.com）',
      items: 'サービスまたは商品は何ですか？数量、説明、価格を教えてください。例：ウェブデザイン3時間、1時間あたり50ドル。',
      due_date: '支払期日はいつですか？',
      notes: 'この請求書に関する備考はありますか？',
    },
    bulk_message: {
      content: 'メッセージの内容は何ですか？',
      subject: 'メッセージの件名は何ですか？',
      recipients: '誰に送りますか？',
      channel: 'メールで送りますか、それともSMSで送りますか？',
    },
    calendar: {
      title: 'ミーティングのタイトルは何ですか？',
      starts_at: 'ミーティングはいつ始まりますか？',
      ends_at: 'いつ終わりますか？',
      description: '議題や説明はありますか？',
    },
    contact: {
      first_name: '連絡先の名は何ですか？',
      last_name: '連絡先の姓は何ですか？',
      phone: '連絡先の電話番号は何ですか？',
      email: '連絡先のメールアドレスは何ですか？（例：john@gmail.com）',
      date_of_birth: '連絡先の生年月日は何ですか？（スキップする場合は「skip」と言ってください）',
      notes: '備考はありますか？（スキップする場合は「skip」と言ってください）',
    },
  },
};
