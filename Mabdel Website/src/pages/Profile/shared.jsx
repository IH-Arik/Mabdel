...
export const INPUT = 'w-full px-4 py-3 bg-[#0A1019] border border-[#243246] text-white rounded-xl outline-none focus:border-[#9333ea]/50 transition-colors text-sm placeholder:text-[#4A5568]';
...
export function Badge({ children, color='cyan' }) {
  const p = { cyan:'bg-[#9333ea]/10 text-[#9333ea] border-[#9333ea]/20', green:'bg-emerald-950/30 text-emerald-400 border-emerald-500/20', yellow:'bg-amber-950/30 text-amber-400 border-amber-500/20', red:'bg-rose-950/30 text-rose-400 border-rose-500/20' };
...
export function StatCard({ label, value, sub, icon: Icon, accent='#9333ea' }) {
  return (
