...
PHRASES: dict[str, dict[str, str]] = {
    ...
    "confirm_send": {
        "en": "Got it{phone_line}{email_line}. So that's {when} for {name}. Should I send this request to the team?",
        "hi": "समझ गया{phone_line}{email_line}। तो यह {name} के लिए {when} है। क्या मैं यह अनुरोध टीम को भेज दूं?",
        "ar": "فهمت{phone_line}{email_line}. إذن هذا {when} لـ {name}. هل أرسل هذا الطلب إلى الفريق؟",
        "es": "Entendido{phone_line}{email_line}. Entonces sería {when} para {name}. ¿Envío esta solicitud al equipo?",
        "fr": "Compris{phone_line}{email_line}. Donc c'est {when} pour {name}. Dois-je envoyer cette demande à l'équipe ?",
        "pt": "Entendido{phone_line}{email_line}. Então é {when} para {name}. Posso enviar essa solicitação para a equipe?",
        "ru": "Понял{phone_line}{email_line}. Итак, это {when} для {name}. Отправить запрос команде?",
        "ur": "سمجھ گیا{phone_line}{email_line}۔ تو یہ {name} کے لیے {when} ہے۔ کیا میں یہ درخواست ٹیم کو بھیج دوں؟",
        "tr": "Anladım{phone_line}{email_line}. Yani {name} için {when}. Bu talebi ekibe göndereyim mi?",
        "zh": "好的{phone_line}{email_line}。那就是{name}的{when}。我现在把这个请求发给团队吗？",
        "ja": "承知しました{phone_line}{email_line}。{name}様、{when}ですね。このリクエストをチームに送信してよろしいですか？",
    },
    "ask_first_name": {
        "en": "Great — what's your first name?",
        "hi": "बढ़िया — आपका पहला नाम क्या है?",
        "ar": "رائع — ما هو اسمك الأول؟",
        "es": "Genial — ¿cuál es tu nombre?",
        "fr": "Parfait — quel est votre prénom ?",
        "pt": "Ótimo — qual é o seu primeiro nome?",
        "ru": "Отлично — как ваше имя?",
        "ur": "بہت اچھا — آپ کا پہلا نام کیا ہے؟",
        "tr": "Harika — adınız nedir?",
        "zh": "好的——请问您的名字是？",
        "ja": "かしこまりました——お名前（下の名前）を教えていただけますか？",
    },
    "ask_last_name": {
        "en": "Thanks, {first_name}. And your last name?",
        "hi": "धन्यवाद, {first_name}। और आपका उपनाम?",
        "ar": "شكرًا، {first_name}. وما هو اسم عائلتك؟",
        "es": "Gracias, {first_name}. ¿Y tu apellido?",
        "fr": "Merci, {first_name}. Et votre nom de famille ?",
        "pt": "Obrigado, {first_name}. E o seu sobrenome?",
        "ru": "Спасибо, {first_name}. А ваша фамилия?",
        "ur": "شکریہ، {first_name}۔ اور آپ کا آخری نام؟",
        "tr": "Teşekkürler, {first_name}. Soyadınız nedir?",
        "zh": "谢谢，{first_name}。请问您的姓氏是？",
        "ja": "ありがとうございます、{first_name}様。苗字を教えていただけますか？",
    },
    "ask_phone_number": {
        "en": "What's the best phone number to reach you at?",
        "hi": "आपसे संपर्क करने के लिए सबसे अच्छा फ़ोन नंबर क्या है?",
        "ar": "ما هو أفضل رقم هاتف للتواصل معك؟",
        "es": "¿Cuál es el mejor número de teléfono para contactarte?",
        "fr": "Quel est le meilleur numéro pour vous joindre ?",
        "pt": "Qual é o melhor número de telefone para contatá-lo?",
        "ru": "Какой номер телефона лучше всего использовать, чтобы с вами связаться?",
        "ur": "آپ سے رابطہ کرنے کے لیے بہترین فون نمبر کیا ہے؟",
        "tr": "Size ulaşabileceğimiz en iyi telefon numarası nedir?",
        "zh": "请问联系您的最佳电话号码是？",
        "ja": "ご連絡先の電話番号を教えていただけますか？",
    },
    "ask_phone_retry": {
        "en": "Sorry, I didn't catch that clearly. Could you say your phone number again, one digit at a time?",
        "hi": "माफ़ करें, मैं ठीक से समझ नहीं पाया। क्या आप अपना फ़ोन नंबर फिर से, एक-एक अंक करके बता सकते हैं?",
        "ar": "عذرًا، لم أفهم ذلك بوضوح. هل يمكنك تكرار رقم هاتفك، رقمًا رقمًا؟",
        "es": "Perdón, no lo entendí bien. ¿Podrías decir tu número de teléfono otra vez, dígito por dígito?",
        "fr": "Désolé, je n'ai pas bien compris. Pourriez-vous répéter votre numéro, chiffre par chiffre ?",
        "pt": "Desculpe, não entendi direito. Você poderia repetir o número, dígito por dígito?",
        "ru": "Извините, я не совсем расслышал. Не могли бы вы продиктовать номер телефона по цифрам?",
        "ur": "معذرت، میں ٹھیک سے سمجھ نہیں سکا۔ کیا آپ اپنا فون نمبر دوبارہ، ایک ایک ہندسہ کر کے بتا سکتے ہیں؟",
        "tr": "Üzgünüm, tam anlayamadım. Telefon numaranızı rakam rakam tekrar söyler misiniz?",
        "zh": "抱歉，我没听清楚。您能再说一遍您的电话号码吗，一个数字一个数字地说？",
        "ja": "申し訳ございません、聞き取れませんでした。電話番号をもう一度、一桁ずつお伝えいただけますか？",
    },
    "confirm_phone_readback": {
        "en": "I have your number as {phone} — is that correct?",
        "hi": "मेरे पास आपका नंबर {phone} है — क्या यह सही है?",
        "ar": "لدي رقمك كـ {phone} — هل هذا صحيح؟",
        "es": "Tengo tu número como {phone} — ¿es correcto?",
        "fr": "J'ai votre numéro : {phone} — est-ce correct ?",
        "pt": "Tenho o seu número como {phone} — está correto?",
        "ru": "У меня записан ваш номер {phone} — это верно?",
        "ur": "میرے پاس آپ کا نمبر {phone} ہے — کیا یہ درست ہے؟",
        "tr": "Numaranız {phone} olarak kayıtlı — doğru mu?",
        "zh": "我记录的您的号码是{phone}——这个对吗？",
        "ja": "お電話番号は{phone}でお間違いないでしょうか？",
    },
    "confirm_email_readback": {
        "en": "And I have your email as {email} — is that correct?",
        "hi": "और मेरे पास आपका ईमेल {email} है — क्या यह सही है?",
        "ar": "ولدي بريدك الإلكتروني كـ {email} — هل هذا صحيح؟",
        "es": "Y tengo tu correo como {email} — ¿es correcto?",
        "fr": "Et j'ai votre e-mail : {email} — est-ce correct ?",
        "pt": "E tenho o seu e-mail como {email} — está correto?",
        "ru": "И у меня записан ваш email {email} — это верно?",
        "ur": "اور میرے پاس آپ کا ای میل {email} ہے — کیا یہ درست ہے؟",
        "tr": "E-postanız {email} olarak kayıtlı — doğru mu?",
        "zh": "我记录的您的邮箱是{email}——这个对吗？",
        "ja": "メールアドレスは{email}でお間違いないでしょうか？",
    },
    "please_confirm_yesno": {
        "en": "Sorry, could you say yes or no?",
        "hi": "माफ़ करें, क्या आप हां या नहीं कह सकते हैं?",
        "ar": "عذرًا، هل يمكنك قول نعم أم لا؟",
        "es": "Perdón, ¿podrías decir sí o no?",
        "fr": "Désolé, pourriez-vous dire oui ou non ?",
        "pt": "Desculpe, você poderia dizer sim ou não?",
        "ru": "Извините, не могли бы вы сказать да или нет?",
        "ur": "معذرت، کیا آپ ہاں یا نہیں کہہ سکتے ہیں؟",
        "tr": "Üzgünüm, evet ya da hayır der misiniz?",
        "zh": "抱歉，您能说是或否吗？",
        "ja": "すみません、はい、または いいえ でお答えいただけますか？",
    },
    "confirm_reask_yesno": {
