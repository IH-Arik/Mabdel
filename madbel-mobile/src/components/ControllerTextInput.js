...
//   console.log('LINE AT 31' , error , label);
...
//         return (
//           <View className="relative w-full border border-red-500 bg-red-500" >
//             {label && (
//               <Text
...
//             <View
//               style={[
//                 { position: 'relative', justifyContent: 'center' , borderWidth:1 , borderColor: 'gray' , borderRadius: 10},
//                 inputWrapperStyle,
//               ]}
//             >
//               {leftIcon && (
